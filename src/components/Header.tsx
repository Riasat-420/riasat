    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
      <div className="container mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-2">
          <Link
            to="/trust"
            className="skeu-nav-pill inline-flex items-center gap-1.5 text-xs text-primary font-semibold"
          >
          ...
          <button
            onClick={toggleTheme}
            className="skeu-icon-btn text-foreground/80 hover:text-foreground"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn-skeu-primary px-4 py-2 rounded-full text-sm font-semibold"
          >
            Say Hi!
          </a>
        </div>
        ...
        <div className="flex md:hidden items-center gap-2">
          ...
          <button
            ...
            className="skeu-icon-btn text-foreground"
